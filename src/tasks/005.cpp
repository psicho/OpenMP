// Задача 5
// Разработать программу для задания 4 при использовании
// специального типа матриц: ленточных, треугольных и т.п.
// Выполнить вычислительные эксперименты при различных правилах
